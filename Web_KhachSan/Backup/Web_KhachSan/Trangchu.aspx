				    ...
				    <div
					    ...
					    <form class="wow fadeInUp">
						    ...
						    <div class="veva-info text-wc center-unit">
							    ...
							    <button class="btn btn-info" type="button">Tìm Hiểu
								    Thêm</button>
						    </div>
					    </form>
				    </div>
        ...
        <div class="block-booking">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2"><asp:TextBox runat="server" ID="TextBox1" CssClass="datepicker-field input-booking" placeholder="Ngày check in"/></div>
                    <div class="col-lg-2"><asp:TextBox runat="server" ID="TextBox2" CssClass="datepicker-field input-booking" placeholder="Ngày check out"/></div>
