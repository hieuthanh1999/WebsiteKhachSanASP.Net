        ...
        <div class="container">
                ...
                <div class="inp-booking">
                    ...
                    <div style="margin: 15px 30px;">
                        <div class="item-booking">
                            <asp:Image Width="100" Height="100" ImageUrl="~/img/BG1.jpg" ID="img1" runat="server" />
                            <br /><asp:Label ID="lblTitle" runat="server" Text="Khách sạn Epci hotel Hà Nội, VIỆT NAM" />
                        </div>
                        <div class="item-booking">
            ...
            <div class="col-lg-8">
               ...
               <table class="table">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td rowspan="2" colspan="3">Đặt chỗ với sự tự tin<br />
                            <img src="img/Credits/Tick.png" width="15" height="15" alt="" />Chi tiết thẻ tín dụng của bạn được an toàn thông qua biểu mẫu thanh toán được bảo đảm này.
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <h3 class="welcomtext"><img src="img/Credits/Service.jpg" alt="" width="25" height="25" runat="server" style="margin-right:10px;" />Dịch vụ tùy chọn.</h3>
                <br />

            <asp:checkboxlist id="checkboxlist1" runat="server" 
                    datasourceid="sqldatasourcekk" datatextfield="name" datavaluefield="id">
                </asp:checkboxlist>
                <asp:SqlDataSource ID="sqldatasourcekk" SelectCommand="SELECT * FROM [ServicesBooking]" runat="server" ConnectionString="<%$ ConnectionStrings:quanlykhachsanConnectionString %>"></asp:SqlDataSource>
             <%--  <asp:     id="sqldatasourcekk" runat="server" 
                    connectionstring="<%$ connectionstrings:quanlykhachsanconnectionstringmm %>" 
                    selectcommand="select * from [servicesbooking]"></asp:sqldatasource>--%>
                
                <div class="welcomtext"><img src="img/Credits/Confrim.png" alt="" width="25" height="25" runat="server" style="margin-right: 10px;"/>Xác nhận đặt phòng</div>
